...
class _RingPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawPath(
      ...
      Paint()
        ..shader = LinearGradient(
          ...
          colors: const [Color(0xFF44403C), Color(0xFF292524), Color(0xFF0C0A09)],
    ...
    canvas.drawRect(Rect.fromLTWH(1.5 * s, 8.2 * s, 2.7 * s, 13.3 * s), postPaint);
    canvas.drawRect(Rect.fromLTWH(27.8 * s, 8.2 * s, 2.7 * s, 13.3 * s), postPaint);

    final innerPostPaint = Paint()..color = const Color(0xFF52525B);
    canvas.drawRRect(
      RRect.fromRectAndRadius(Rect.fromLTWH(3.8 * s, 7.6 * s, 2.2 * s, 13.8 * s), Radius.circular(0.4 * s)),
      innerPostPaint,
    );
    canvas.drawRRect(
      RRect.fromRectAndRadius(Rect.fromLTWH(26.0 * s, 7.6 * s, 2.2 * s, 13.8 * s), Radius.circular(0.4 * s)),
      innerPostPaint,
    );
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(Rect.fromLTWH(3.4 * s, 7.2 * s, 3.0 * s, 2.2 * s), Radius.circular(0.35 * s)),
      capPaint,
    );
    canvas.drawRRect(
      RRect.fromRectAndRadius(Rect.fromLTWH(25.6 * s, 7.2 * s, 3.0 * s, 2.2 * s), Radius.circular(0.35 * s)),
      capPaint,
    );

    // 로프 3개 (위→아래, 레드 그라데이션)
    _drawRope(canvas, size, s, 3.2, 10.1, 28.8, 11.05,
        const [Color(0xFF991B1B), Color(0xFFDC2626), Color(0xFF7F1D1D)]);
    _drawRope(canvas, size, s, 2.3, 13.35, 29.7, 14.65,
        const [Color(0xFFB91C1C), Color(0xFFEF4444), Color(0xFF991B1B)]);
    _drawRope(canvas, size, s, 1.4, 17.1, 30.6, 18.85,
        const [Color(0xFFDC2626), Color(0xFFF87171), Color(0xFFB91C1C)]);
    ...
    canvas.drawLine(Offset(16 * s, 20.2 * s), Offset(14.2 * s, 18.8 * s), figurePaint);
    canvas.drawLine(Offset(16 * s, 20.2 * s), Offset(17.8 * s, 18.8 * s), figurePaint);
  }

  void _drawRope(
    Canvas canvas, Size size, double s,
    double lx, double y1, double rx, double y2,
    List<Color> colors,
  ) {
    canvas.drawPath(
      Path()
